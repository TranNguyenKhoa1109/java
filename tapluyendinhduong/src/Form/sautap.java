package Form;
public class sautap extends javax.swing.JFrame {
    public sautap() {
        initComponents();
    }
    private void initComponents() {
        ...
        setTitle("Dinh dưỡng");
        setName("fram"); 
        jLabel1.setText("Thực phẩm ăn sau buổi tập :");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sautap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
